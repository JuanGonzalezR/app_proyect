...
const String createTables =
    'CREATE TABLE user(usu_id INTEGER PRIMARY KEY AUTOINCREMENT,usu_nombre TEXT,usu_apellido TEXT,usu_email TEXT,usu_password TEXT,usu_fechaNacimiento TEXT,usu_genero TEXT,usu_pais TEXT,usu_fechaCreacion TEXT,usu_fechaModificacion TEXT,usu_fechaInactivacion TEXT,usu_estado TEXT)';
...
const titleProfileUser = Text('Perfil',
    style:
        TextStyle(fontSize: 50.0, fontFamily: 'Winkle', color: Colors.white70));
